...
function saveCurrentEditor() {
    ...
    document.querySelectorAll(".q-value").forEach(inp=>{ const ci=parseInt(inp.dataset.cat), qi=parseInt(inp.dataset.qidx); updateQuestion(editingQuizId, ci, qi, {value:parseInt(inp.value)||100}); });
...
function addCategoryInEditor() { addCategoryToQuiz(editingQuizId); openEditor(editingQuizId); }
